...
insert into products (name-products, description, code, price) values (
...
insert into type (name-type) values ('GPU');
insert into type (name-type) values ('CPU');
insert into type (name-type) values ('RAM');
insert into type (name-type) values ('Monitor');
insert into type (name-type) values ('Keyboard');
insert into type (name-type) values ('Storage');
